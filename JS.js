...
function validation(){
    //document.getElementById("demo").innerHTML = options.length;
    const ticks = document.getElementsByClassName("tick");
    const answers = document.getElementsByClassName("answer");
    ...
    //document.getElementById("demo").innerHTML = correctAnswers.length;
    points = 0;
}
